<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $stmt = $conn->prepare("INSERT INTO alternative_comparisons(criterion, alternative1, alternative2, alt_value) VALUES ('keamanan', ?, ?, ?)");
    ...
    header('Location: pilihan_car_kapasitas-baterai.php');
    exit();
    ...
    <body>
        ...
        <main>
            <div class="container" style="margin-top: 3.9rem; padding-left: 0px; padding-right: 0px">
                <p style="font-size: 40px; font-weight: 700; margin-bottom: 3.9rem">Preferensi Penilaian Rating Keamanan</p>
